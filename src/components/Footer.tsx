              ...
              <div>
                ...
                <ul className="mt-4 space-y-3">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-sm text-muted-foreground">Block C4, EL-rufai Estate, APO, Abuja, FCT</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <Mail className="h-5 w-5 flex-shrink-0 text-primary" />
                     <a href="mailto:info@netflowhomes.com.ng" className="text-sm text-muted-foreground hover:text-primary">info@netflowhomes.com.ng</a>
                  </li>
                  <li className="flex items-center gap-3">
                    <Phone className="h-5 w-5 flex-shrink-0 text-primary" />
                    <a href="tel:+2348068969156" className="text-sm text-muted-foreground hover:text-primary">(+234) 806 896 9156</a>
                  </li>
                </ul>
              </div>
               <div>
